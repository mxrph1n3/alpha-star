...
const translations = {
    RU: {
        ...
        blog: { top: 'Аналитика и Инсайты', title: 'Блог Alpha Star', read: 'мин чтения', readBtn: 'Читать статью', notFound: 'Статья не найдена', back: 'Назад к статьям', ready: 'Готовы сделать шаг к успешным инвестициям?', reqBtn: 'Получить консультацию эксперта', imgText: 'Главное фото статьи' },
    ...
    EN: {
        ...
        blog: { top: 'Insights & Analytics', title: 'Alpha Star Blog', read: 'min read', readBtn: 'Read Article', notFound: 'Article not found', back: 'Back to Articles', ready: 'Ready to step into successful investments?', reqBtn: 'Get Expert Consultation', imgText: 'Article Main Photo' },
