...
const blogPosts = [
    { id: "dubai-market-2026", title: "Рынок недвижимости Дубая 2026: прогнозы и новые тренды", date: "14 Октября, 2025", readTime: "5 мин", img: "https://images.unsplash.com/photo-1518684079-3c830dcef090?auto=format&fit=crop&q=80&w=1200", excerpt: "Подробный разбор тенденций рынка недвижимости ОАЭ, изменения в законодательстве и новые инвестиционные зоны, которые покажут наибольший рост.", content: `<p>Рынок недвижимости Дубая продолжает демонстрировать феноменальную устойчивость, привлекая капиталы со всего мира. Вступая в 2026 год, инвесторы задаются главным вопросом: сохранится ли двузначный рост или рынок перейдет в фазу стабилизации?</p><h3>Смещение фокуса на Ultra-Luxury</h3><p>Спрос на <strong>элитную недвижимость в Дубае</strong> со стороны HNWI бьет абсолютные исторические рекорды. Проекты от таких мировых брендов, как Cavalli и Bulgari, распродаются на стадии закрытых пресейлов.</p><h3>Какие районы покажут максимальный ROI?</h3><ul><li><strong>Dubai Maritime City:</strong> Новые прибрежные районы с огромным потенциалом для сдачи в краткосрочную аренду.</li><li><strong>Dubai South и JVC:</strong> Безоговорочные лидеры по доходности от долгосрочной аренды (7.5% – 9.5% годовых).</li></ul>` },
    { id: "golden-visa-uae", title: "Как получить Golden Visa (Золотую визу) инвестору в ОАЭ", date: "28 Сентября, 2025", readTime: "4 мин", img: "https://images.unsplash.com/photo-1549944850-84e00be4203b?auto=format&fit=crop&q=80&w=1200", excerpt: "Пошаговая инструкция по получению Золотой визы в Дубае за инвестиции в недвижимость. Условия, преимущества и новые правила 2026 года.", content: `<p>Государственная программа <strong>Golden Visa (Золотая виза)</strong> сроком на 10 лет стала главным магнитом для международных инвесторов и предпринимателей.</p><h3>Главные преимущества</h3><ul><li><strong>Долгосрочная безопасность:</strong> Проживание в течение 10 лет с правом продления.</li><li><strong>Спонсирование семьи:</strong> Оформление виз для супруга(и) и детей.</li><li><strong>Финансовая свобода:</strong> Доступ к открытию счетов в надежных банках ОАЭ, 0% налога на доходы.</li></ul><h3>Условия получения</h3><p>Главное условие — необходимо <strong>купить недвижимость в Дубае</strong> на сумму не менее <strong>2 000 000 дирхамов</strong> (около $545,000).</p>` }
];
...
const awardsList = [
    { img: "" }, // Здесь в будущем тоже пишите пути с точкой: "./images/award1.png"
    { img: "" },
    { img: "" },
    { img: "" }
];
                ...
                <div className="grid gap-16 md:gap-20">
                    {blogPosts.map((post) => (
                        <div key={post.id} className="group grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center border-b border-gray-100 pb-16 md:pb-20">
                            <Link to={`/blog/${post.id}`} className="block aspect-[4/3] bg-gray-100 overflow-hidden shadow-lg order-1 md:order-none">
