...
const translations = {
    RU: {
        ...
        blog: { top: 'Блог', title: 'Блог Alpha Star', read: 'мин чтения', readBtn: 'Читать статью', notFound: 'Статья не найдена', back: 'Назад к статьям', ready: 'Готовы сделать шаг к успешным инвестициям?', reqBtn: 'Получить консультацию эксперта', imgText: 'Главное фото статьи' },
    ...
    EN: {
        ...
        blog: { top: 'Blog', title: 'Alpha Star Blog', read: 'min read', readBtn: 'Read Article', notFound: 'Article not found', back: 'Back to Articles', ready: 'Ready to step into successful investments?', reqBtn: 'Get Expert Consultation', imgText: 'Article Main Photo' },
...
const getCaseStudies = (lang) => [
    { img: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&q=80&w=1200", roi: '120-200%', location: 'Bluewaters Island', title: 'BLUEWATERS RESIDENCES', project: lang==='RU'?'1 BEDROOM (РАЙОН)':'1 BEDROOM (AREA)', launch: '1.9М — 2.2М AED', now: '4.7М — 6.8М AED' },
    { img: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=1200", roi: '60-70%', location: 'Dubai Hills Estate', title: 'ELLINGTON HOUSE', project: lang==='RU'?'3 BEDROOM (ПРОЕКТ)':'3 BEDROOM (PROJECT)', launch: '3.3М — 4.0М AED', now: '5.5М — 6.5М AED' },
    { img: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&q=80&w=1200", roi: '90-120%', location: 'Emaar Beachfront', title: 'BEACH ISLE', project: lang==='RU'?'3 BEDROOM (ПРОЕКТ)':'3 BEDROOM (PROJECT)', launch: '4.5М AED', now: '8.5М — 10.3М AED' },
    { img: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=1200", roi: '70%', location: 'JVC', title: 'BINGHATTI CORNER', project: lang==='RU'?'1 BEDROOM (ПРОЕКТ)':'1 BEDROOM (PROJECT)', launch: '600,000 AED', now: '1М AED' }
];
                        ...
                        <div key={post.id} className="group grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center border-b border-gray-100 pb-16 md:pb-20">
                            ...
                            <div className="text-left order-2 md:order-none">
                                <div className="flex flex-wrap items-center gap-3 md:gap-4 mb-3 md:mb-4">
                                    ...
                                    <span className="text-gray-400 flex items-center gap-1 text-[8px] md:text-[9px] uppercase font-bold tracking-widest"><Clock size={12} /> {post.readTime} {t.blog.read}</span>
                                </div>
            ...
            <article className="max-w-4xl mx-auto px-5 md:px-8">
                ...
                <div className="mb-8 md:mb-12">
                    <div className="flex flex-wrap items-center gap-4 md:gap-6 mb-4 md:mb-6 text-[9px] md:text-[10px] uppercase font-bold tracking-widest text-gray-400">
                        ...
                        <span className="flex items-center gap-1 md:gap-2"><Clock size={14} /> {post.readTime} {t.blog.read}</span>
                    </div>
                        ...
                        {caseStudies.map((item, i) => (
                            <div key={i} className="bg-white shadow-[0_10px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_60px_rgba(197,160,89,0.12)] transition-all duration-700 group border border-gray-50 flex flex-col lg:flex-row overflow-hidden hover:-translate-y-1 rounded-sm">
                                <div className="w-full lg:w-2/5 bg-[#0A0A0A] aspect-video md:aspect-[4/3] lg:aspect-auto flex flex-col items-center justify-center relative overflow-hidden p-6 md:p-8 min-h-[200px]">
                                    ...
                                    <span className="font-cormorant text-white/20 text-3xl md:text-4xl lg:text-5xl tracking-[0.3em] lg:tracking-[0.4em] uppercase group-hover:scale-105 transition-transform duration-700 relative z-10 text-center font-bold">{t.deals.private}</span>
                                    <span className="font-montserrat text-[#C5A059] text-[8px] md:text-[9px] uppercase tracking-[0.2em] lg:tracking-[0.3em] mt-3 md:mt-4 opacity-50 group-hover:opacity-100 transition-opacity relative z-10">{t.deals.conf}</span>
                                </div>
